...
Because of the associativity of those operations, the representation of the boolean operators AND and OR can have arbitrary arity - take an arbitrary number of parameters.
...
Storing the expressions in strings is therefore a second most fluent option.
