...
\begin{itemize}
    ...
    \item Open format - The automations written in Cypress are \acs{JS} programs.
\end{itemize}
\clearpage
...
Unlike Cypress and Selenium, Puppeteer oficially supports Chromium based browsers as its only backend browsers as of now (\today).
...
\begin{itemize}
    ...
    Unlike Puppeteer, \acs{TS}/\acs{JS} version of Playwright comes with Playwright Test, a simple test-runner using a Jest-inspired syntax.
