...
\include{chapters/docs/documentation}
...
\include{chapters/additional/abbreviations}
...
\unless\ifdefined\short
	\appendix
	\chapter{Attachments}
	\input{./attachments/SUSsurvey.tex}
	\clearpage
	\input{./attachments/wbrInterpretDocs.tex}
	\clearpage
	\input{./attachments/wbrEditorDocs.tex}
	\clearpage
	\input{./attachments/wbrCloudDocs.tex}
\fi
